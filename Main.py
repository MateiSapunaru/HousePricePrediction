...
# Dropping ID column and handle missing SalePrice values
...
# Re-encoding categorical columns using One-Hot Encoding
...
# Combining one-hot encoded columns with the dataset
